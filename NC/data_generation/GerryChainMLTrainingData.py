...
for part in chain:
    ...
    if int(counter) == counter:
        ...
        avg_elect = avg[0]
        mean_median_val = gm.mean_median(avg_elect)
        print(mean_median_val)
        MM_array.append(mean_median_val)
    counter = counter + 1
...
json_with_data = {
    ...
    "MeanMedianArray": MM_array,
    "PrecinctIdentifier": precinct_identifier,
}

with open("10KPlansFinal.json", "w") as data_file:
